...
private:
    ...
    gpio_t ce_pin; /**< "Chip Enable" pin, activates the RX or TX role */
    gpio_t csn_pin; /**< SPI Chip select */
...
public:
     ...
     */
    RF24(gpio_t _cepin, gpio_t _cspin, spi_t& _spi);
  ...
  s   *
    ...
    */
    ...
    bool isValid()
    {
        return ce_pin.pin != 0xff && csn_pin.pin != 0xff;
    }
